...
export const CustomCursor = () => {
  ...
  return (
    <>
      ...
      <div
        ref={cursorDotRef}
        className={`fixed top-0 left-0 w-2 h-2 bg-white rounded-full pointer-events-none z-[10051] mix-blend-difference transition-opacity duration-300 ${
      ...
      <div
        ...
        className={`fixed top-0 left-0 rounded-full pointer-events-none z-[10050] mix-blend-difference transition-[width,height,background-color,border-color] duration-300 ease-out flex items-center justify-center ${
          isHovering 
